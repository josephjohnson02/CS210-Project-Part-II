...
The goal of the project is to create a desktop application that is fast and easy to use. Its interface will be simple to understand and effective at creating and modifying palettes for the user, using algorithms made by myself to simulate harmony rules of color theory such as complementary, analogous and triadic schemes to ensure they’re aesthetically coherent.
